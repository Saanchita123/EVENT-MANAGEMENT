...
session_start();
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($result->num_rows > 0) {
            ...
            $_SESSION['studentid'] = $user['studentid']; // Assuming "id" is the primary key
            $_SESSION['name'] = $user['name'];
            $_SESSION['email'] = $user['email']; // Add other fields if needed
            exit();
        } else {
            // Invalid credentials
...
<body>
    ...
    <div class="card">
        ...
        <h2>Student Login</h2>
        <form method="post">
            <div class="form-group" action="studentdashboard.php">
            ...
            <button type="submit" class="login-button">Login</button>
                <p class="create-account-link">Don't have an account? <a href="newaccountstudent11.php">Create Account</a></p>
            </div>
        </form>
    </div>
</div>
